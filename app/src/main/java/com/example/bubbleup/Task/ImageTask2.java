...
public class ImageTask2 extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "ImageTask2";
    private String url, les_no;
    ...
    public ImageTask2(String url, String les_no, int imageSize) {

        this(url, les_no, imageSize, null);
    }

    public ImageTask2(String url, String les_no, int imageSize, ImageView imageView) {
        this.url = url;
        this.les_no = les_no;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("action", "getLespic");
